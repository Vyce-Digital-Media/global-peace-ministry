...
const CHAPTERS = [
   ...
   { id: 7, title: 'Chapter 7', file: 'Chapter 7.mp3', pdfPage: 60 },
...
export default function AudiobookPage() {
   ...
   const startPage = currentTrack.pdfPage;
   const nextTrack = CHAPTERS[currentTrackIndex + 1];
   const endPage = nextTrack ? nextTrack.pdfPage - 1 : numPages;
   ...
   return (
      <div className="flex flex-col w-full bg-[#e8e4db] min-h-screen pt-32 pb-24 px-4 md:px-8">
         <div className="max-w-[1600px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8">

            {/* Left Column: Chapters Index */}
            <div className="lg:col-span-3 h-[calc(100vh-12rem)] sticky top-32 overflow-hidden">
            ...
            <div className="lg:col-span-6 h-[calc(100vh-12rem)] sticky top-32">
               <div 
                  className="bg-white/90 backdrop-blur-md rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] border border-muted-teal/10 h-full flex flex-col overflow-y-auto overflow-x-hidden custom-scrollbar"
               ...
               >
                  <Document
                     ...
                     loading={
                        <div className="flex items-center justify-center h-full text-primary-900/50 p-8">
                           Loading chapter content...
                        </div>
                     }
                     className="flex flex-col items-center w-full min-h-full py-6 px-4"
                  >
                     {pagesToRender.map(page => (
                        <div key={page} className="w-full max-w-[600px] mb-8 shadow-xl bg-white overflow-hidden rounded-md">
                           <Page 
                              pageNumber={page}
                              renderTextLayer={false}
                              renderAnnotationLayer={false}
                              scale={2}
                              className="w-full h-auto origin-top-left [&>.react-pdf__Page__canvas]:!w-full [&>.react-pdf__Page__canvas]:!h-auto"
                           />
                        </div>
                     ))}
                  </Document>
            ...
            <div className="lg:col-span-3 sticky top-32 h-fit">
